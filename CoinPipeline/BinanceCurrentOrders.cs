...
{
	public static class BinanceCurrentOrders
	{
		const string APIURI = "https://api.binance.com/api/v1/depth?symbol=BTCUSDT";
		...
		public static void Retrieve()
		{
			...
			StreamWriter tw = new StreamWriter("Binance_" + time.ToString() + ".csv");
			...
			swatch.Stop();
			File.AppendAllText("Timings", "Entry: Binance " + time.ToString() + "\nPrequery: " + prequery.TotalMilliseconds
